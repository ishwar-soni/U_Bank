...
public class Application {
    ...
    //Account array to store account objects for the application, later in the course this array will be replaced with
    //database
    ...
    //This method is used to perform login function for the user. If the user is already logged in, then he won't be
    //able to login again. Also a user can only login, if the account no and password provided by the user are present
    ...
    //be able to register. Also a user can only register, if the account no and password provided by the user are not
    //present in the accounts array.
